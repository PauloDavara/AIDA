...
base_url = 'https://www.aepd.es/informes-y-resoluciones/resoluciones?page='

# Número de páginas
num_pages = 4484  # Número total de páginas
...
for page in range(0, num_pages + 1):
    ...
    for link in pdf_links:
        ...
        if title_element:
            title = f"Resolución {title_element}"  # Formato requerido del título
        else:
...
print("Proceso completado y datos guardados en 'resoluciones.csv'")
